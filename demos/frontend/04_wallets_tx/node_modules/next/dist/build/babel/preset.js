...
var _default = (api, options = {})=>{
    ...
    const useJsxRuntime = ((ref = options['preset-react']) === null || ref === void 0 ? void 0 : ref.runtime) === 'automatic' || Boolean(api.caller((caller)=>!!caller && caller.hasJsxRuntime
    )) && ((ref1 = options['preset-react']) === null || ref1 === void 0 ? void 0 : ref1.runtime) !== 'classic';

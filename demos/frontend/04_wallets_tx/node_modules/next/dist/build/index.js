        ...
        const { customAppGetInitialProps , namedExports , isNextImageImported: isNextImageImported1 , hasSsrAmpPages: hasSsrAmpPages1 , hasNonStaticErrorPage ,  } = await staticCheckSpan.traceAsyncFn(async ()=>{
            ...
            await Promise.all(pageKeys.map(async (page)=>{
                ...
                return checkPageSpan.traceAsyncFn(async ()=>{
                    ...
                    const pageRuntime = hasConcurrentFeatures && pagePath ? await (0, _entries).getPageRuntime((0, _path).join(pagesDir, pagePath), config.experimental.runtime) : undefined;
                    ...
                    pageInfos.set(page, {
                        ...
                        runtime: !(0, _utils2).isReservedPage(page) && !(0, _utils2).isCustomErrorPage(page) ? pageRuntime : undefined,

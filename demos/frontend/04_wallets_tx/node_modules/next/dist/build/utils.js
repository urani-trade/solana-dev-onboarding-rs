...
async function printTreeView(list, pageInfos, serverless, { distPath , buildId , pagesDir , pageExtensions , buildManifest , useStatic404 , gzipSize =true  }) {
    ...
    pageList.forEach((item, i, arr)=>{
        ...
        , 0)) || 0);
        const symbol = item === '/_app' ? ' ' : item.endsWith('/_middleware') ? 'ƒ' : (pageInfo === null || pageInfo === void 0 ? void 0 : pageInfo.static) ? '○' : (pageInfo === null || pageInfo === void 0 ? void 0 : pageInfo.isSsg) ? '●' : (pageInfo === null || pageInfo === void 0 ? void 0 : pageInfo.runtime) === 'edge' ? 'ℇ' : 'λ';

    ...
    return function(Module1) {
        ...
        function createWasm() {
            ...
            function receiveInstance(instance, module) {
                ...
                Module1['asm'] = exports;
                wasmMemory = Module1['asm']['P'];
                updateGlobalBufferAndViews(wasmMemory.buffer);
                wasmTable = Module1['asm']['Y'];
                addOnInit(Module1['asm']['Q']);
        ...
        var ___wasm_call_ctors = Module1['___wasm_call_ctors'] = function() {
            return (___wasm_call_ctors = Module1['___wasm_call_ctors'] = Module1['asm']['Q']).apply(null, arguments);
        };
        var _malloc = Module1['_malloc'] = function() {
            return (_malloc = Module1['_malloc'] = Module1['asm']['R']).apply(null, arguments);
        };
        var _free = Module1['_free'] = function() {
            return (_free = Module1['_free'] = Module1['asm']['S']).apply(null, arguments);
        };
        var ___getTypeName = Module1['___getTypeName'] = function() {
            return (___getTypeName = Module1['___getTypeName'] = Module1['asm']['T']).apply(null, arguments);
        };
        var ___embind_register_native_and_builtin_types = Module1['___embind_register_native_and_builtin_types'] = function() {
            return (___embind_register_native_and_builtin_types = Module1['___embind_register_native_and_builtin_types'] = Module1['asm']['U']).apply(null, arguments);
        };
        var stackSave = Module1['stackSave'] = function() {
            return (stackSave = Module1['stackSave'] = Module1['asm']['V']).apply(null, arguments);
        };
        var stackRestore = Module1['stackRestore'] = function() {
            return (stackRestore = Module1['stackRestore'] = Module1['asm']['W']).apply(null, arguments);
        };
        var _setThrew = Module1['_setThrew'] = function() {
            return (_setThrew = Module1['_setThrew'] = Module1['asm']['X']).apply(null, arguments);
        };
        var dynCall_jiiiiiiiii = Module1['dynCall_jiiiiiiiii'] = function() {
            return (dynCall_jiiiiiiiii = Module1['dynCall_jiiiiiiiii'] = Module1['asm']['Z']).apply(null, arguments);
        };
        var dynCall_ijiii = Module1['dynCall_ijiii'] = function() {
            return (dynCall_ijiii = Module1['dynCall_ijiii'] = Module1['asm']['_']).apply(null, arguments);
        };
        var dynCall_jiji = Module1['dynCall_jiji'] = function() {
            return (dynCall_jiji = Module1['dynCall_jiji'] = Module1['asm']['$']).apply(null, arguments);
        };
        var dynCall_jiiiiiiii = Module1['dynCall_jiiiiiiii'] = function() {
            return (dynCall_jiiiiiiii = Module1['dynCall_jiiiiiiii'] = Module1['asm']['aa']).apply(null, arguments);
        };
        var dynCall_jiiiiii = Module1['dynCall_jiiiiii'] = function() {
            return (dynCall_jiiiiii = Module1['dynCall_jiiiiii'] = Module1['asm']['ba']).apply(null, arguments);
        };
        var dynCall_jiiiii = Module1['dynCall_jiiiii'] = function() {
            return (dynCall_jiiiii = Module1['dynCall_jiiiii'] = Module1['asm']['ca']).apply(null, arguments);
        };
        var dynCall_iiijii = Module1['dynCall_iiijii'] = function() {
            return (dynCall_iiijii = Module1['dynCall_iiijii'] = Module1['asm']['da']).apply(null, arguments);
        };
...
//# sourceMappingURL=avif_node_enc.js.map
    ...
    return function(Module1) {
        ...
        function createWasm() {
            ...
            function receiveInstance(instance, module) {
                ...
                Module1['asm'] = exports;
                wasmMemory = Module1['asm']['x'];
                updateGlobalBufferAndViews(wasmMemory.buffer);
                wasmTable = Module1['asm']['D'];
                addOnInit(Module1['asm']['y']);
        ...
        var ___wasm_call_ctors = Module1['___wasm_call_ctors'] = function() {
            return (___wasm_call_ctors = Module1['___wasm_call_ctors'] = Module1['asm']['y']).apply(null, arguments);
        };
        var _malloc = Module1['_malloc'] = function() {
            return (_malloc = Module1['_malloc'] = Module1['asm']['z']).apply(null, arguments);
        };
        var _free = Module1['_free'] = function() {
            return (_free = Module1['_free'] = Module1['asm']['A']).apply(null, arguments);
        };
        var ___getTypeName = Module1['___getTypeName'] = function() {
            return (___getTypeName = Module1['___getTypeName'] = Module1['asm']['B']).apply(null, arguments);
        };
        var ___embind_register_native_and_builtin_types = Module1['___embind_register_native_and_builtin_types'] = function() {
            return (___embind_register_native_and_builtin_types = Module1['___embind_register_native_and_builtin_types'] = Module1['asm']['C']).apply(null, arguments);
        };
        var calledRun;
...
//# sourceMappingURL=webp_node_enc.js.map
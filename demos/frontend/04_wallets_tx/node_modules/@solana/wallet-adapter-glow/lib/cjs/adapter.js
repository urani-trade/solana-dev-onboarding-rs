...
exports.GlowWalletAdapter = exports.GlowWalletName = void 0;
const wallet_adapter_base_1 = require("@solana/wallet-adapter-base");
const web3_js_1 = require("@solana/web3.js");
exports.GlowWalletName = 'Glow';
class GlowWalletAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
    constructor(_config = {}) {
        super();
        this.name = exports.GlowWalletName;
        ...
        if (this._readyState !== wallet_adapter_base_1.WalletReadyState.Unsupported) {
            ...
            (0, wallet_adapter_base_1.scopePollingDetectionStrategy)(() => {
                var _a;
                if ((_a = window.glowSolana) === null || _a === void 0 ? void 0 : _a.isGlow) {
                    window.removeEventListener('message', handler);
                    if (this._readyState !== wallet_adapter_base_1.WalletReadyState.Installed) {
                        this._readyState = wallet_adapter_base_1.WalletReadyState.Installed;
                        this.emit('readyStateChange', this._readyState);
    ...
    sendTransaction(transaction, connection, options) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return yield _super.sendTransaction.call(this, transaction, connection, options);
        });
    }

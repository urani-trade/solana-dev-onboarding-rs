...
exports.SolflareWalletAdapter = exports.SolflareWalletName = void 0;
const wallet_adapter_base_1 = require("@solana/wallet-adapter-base");
const web3_js_1 = require("@solana/web3.js");
exports.SolflareWalletName = 'Solflare';
class SolflareWalletAdapter extends wallet_adapter_base_1.BaseMessageSignerWalletAdapter {
    constructor(config = {}) {
        super();
        this.name = exports.SolflareWalletName;
        ...
        if (this._readyState !== wallet_adapter_base_1.WalletReadyState.Unsupported) {
            (0, wallet_adapter_base_1.scopePollingDetectionStrategy)(() => {
                var _a;
                if (((_a = window.solflare) === null || _a === void 0 ? void 0 : _a.isSolflare) || window.SolflareApp) {
    ...
    connect() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let SolflareClass;
                try {
                    ({ default: SolflareClass } = yield Promise.resolve().then(() => __importStar(require('@solflare-wallet/sdk'))));
                }
                catch (error) {

            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        transaction.addSignature(new web3_js_1.PublicKey(publicKey), bs58_1.default.decode(signature));
                ...
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._sendMessage({
                                ...
                                params: {
                                    messages: transactions.map(function (transaction) { return bs58_1.default.encode(transaction.serializeMessage()); })
                                }
                            })];
                    case 2:
                        _a = _b.sent(), publicKey_1 = _a.publicKey, signatures_1 = _a.signatures;
                        return [2 /*return*/, transactions.map(function (tx, id) {
                                tx.addSignature(new web3_js_1.PublicKey(publicKey_1), bs58_1.default.decode(signatures_1[id]));
                                return tx;
                            })];
                    case 3:
                        e_2 = _b.sent();
